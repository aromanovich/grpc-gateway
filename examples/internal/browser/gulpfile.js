...
gulp.task('server', shell.task([
  'go build -o bin/example-server github.com/aromanovich/grpc-gateway/examples/internal/cmd/example-grpc-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw github.com/aromanovich/grpc-gateway/examples/internal/cmd/example-gateway-server',
]));
