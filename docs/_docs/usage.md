...
2. Add a [custom option](https://cloud.google.com/service-management/reference/rpc/google.api#http) to the .proto file
   ...
   See [a_bit_of_everything.proto](https://github.com/aromanovich/grpc-gateway/blob/master/examples/internal/proto/examplepb/a_bit_of_everything.proto)
...
3. Generate gRPC stub
   ...
   protoc -I/usr/local/include -I. \
     -I$GOPATH/src \
     -I$GOPATH/src/github.com/aromanovich/grpc-gateway/third_party/googleapis \
     --go_out=plugins=grpc:. \
...
[openapiv2.proto](https://github.com/aromanovich/grpc-gateway/blob/master/protoc-gen-swagger/options/openapiv2.proto) - see
[a_bit_of_everything.proto](https://github.com/aromanovich/grpc-gateway/blob/master/examples/internal/proto/examplepb/a_bit_of_everything.proto)
for examples.
